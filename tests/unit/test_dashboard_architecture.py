...
def test_no_db_imports_in_dashboard_modules():
    """Verify no dashboard module imports SessionLocal, HashChainService, or DB models."""
    import inspect
    ...
    for term in forbidden_terms:
        assert term not in source, f"Forbidden term '{term}' found in dashboard api_client.py!"
